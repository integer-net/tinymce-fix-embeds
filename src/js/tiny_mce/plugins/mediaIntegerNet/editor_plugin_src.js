...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaIntegerNetPlugin', {
		init : function(ed, url) {
			...
			// Register buttons
			ed.addButton('mediaIntegerNet', {title : 'media.desc', cmd : 'mceMedia', image: '/js/tiny_mce/plugins/mediaIntegerNet/img/media.gif'});

			// Update media selection status
			ed.onNodeChange.add(function(ed, cm, node) {
				cm.setActive('mediaIntegerNet', isMediaImg(node));
			});
		},
	...
	// Register plugin
	tinymce.PluginManager.add('mediaIntegerNet', tinymce.plugins.MediaIntegerNetPlugin);
})();
